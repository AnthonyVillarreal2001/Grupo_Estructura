...
void Cmenu::menuPrincipal() {
    ...
    do {
        ...
        strcpy_s(dato, ingresarDatosEnteros(const_cast<char*>("\n>Ingrese la opcion deseada: ")));
        opcion = atoi(dato);
        ...
        case 1: {
            ...
            strcpy_s(dato1, ingresarDatosEnteros(const_cast <char*>("\n>Ingrese el valor a la lista: ")));
        ...
        case 2: {
            ...
            // código
            strcpy_s(dato2, ingresarDatosEnteros(const_cast <char*>("\n>Ingrese el valor a la lista: ")));
        ...
        case 4: {
            ...
            // código
            listaCab.imprimir();
            strcpy_s(dato3, ingresarDatosEnteros(const_cast <char*>("\n>Ingrese el numero de elementos a eliminar: ")));
        ...
        case 5: {
            ...
            // código
            listaCol.imprimir();
            strcpy_s(dato4, ingresarDatosEnteros(const_cast <char*>("\n>Ingrese el numero de elementos a eliminar: ")));
