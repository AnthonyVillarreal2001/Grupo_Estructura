...
void Clista::eliminarCol(int eliminar) {
    int i = 0;
    Cnodo* aux = this->origen;
    Cnodo* aux2 = nullptr; // Inicialización de aux2
    if (ListaVacia()) {
        ...
        if (eliminar <= tamanioLista()) {
            ...
            if (eliminar == tamanioLista()) {
                ...
                do {
                    ...
                    delete aux;
                    aux = origen;
                    aux2 = nullptr; // Reinicialización de aux2
                    while (aux->getSiguiente()) {
                        aux2 = aux;
                        aux = aux->getSiguiente();
                    }
            ...
            printf("\nNo se puede eliminar más del tamaño de la lista\n");
        }
    }
}
//void Clista::eliminarCol(int eliminar){
